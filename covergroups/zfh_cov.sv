...
covergroup zfhext__cg with function sample(csr_cov_sample i_csr);
    ...
    zfhext__rounding_modes_invalid_FRM: coverpoint Inst[14:12] {
        bins illegal_mode[] = {5,6} iff((match_zfhext==1) && ((instrenum_var != INSTRENUM_FLH) || (instrenum_var != INSTRENUM_FSH))); 
    }

    zfhext__rounding_modes_static_legal_rm : coverpoint Inst[14:12] {
        bins hit[] = {0,1,2,3,4} iff(match_zfhext==1);
    }
   
    zfhext__rounding_modes_dynamic_illegal: coverpoint i_csr.fcsr_csr_inst.frm{
    bins illegal_mode_2[] = {3'd5,3'd6,3'd7} iff((match_zfhext==1) && (Inst[14:12] == 3'b111) && ((instrenum_var != INSTRENUM_FLH) || (instrenum_var != INSTRENUM_FSH))); 
    }
 
    zfhext__rounding_modes_dynamic_legal: coverpoint i_csr.fcsr_csr_inst.frm{
        bins dynamic_mode[] = {3'd1,3'd2,3'd3,3'd0,3'd4} iff((match_zfhext==1) && (Inst[14:12] == 3'd7) && ((instrenum_var != INSTRENUM_FLH) || (instrenum_var != INSTRENUM_FSH)));
    }
    ...
    zfhext__rounding_modes_edge_case: coverpoint instrenum_var{
        bins L_XLENx1plus={INSTRENUM_FMUL_H} iff((rs1_val[15:0]==ZFHEXT_LN) && (rs2_val[15:0]==ZFHEXT_ONE_PLUS) || (rs2_val[15:0]==ZFHEXT_LN) && (rs1_val[15:0]==ZFHEXT_ONE_PLUS));
        bins negL_XLENxneg1plus={INSTRENUM_FMUL_H} iff((rs1_val[15:0]==ZFHEXT_LN_NEG) && (rs2_val[15:0]==ZFHEXT_ONE_PLUS_NEG) || (rs2_val[15:0]==ZFHEXT_LN_NEG) && (rs1_val[15:0]==ZFHEXT_ONE_PLUS_NEG));
        bins L_XLENxS_XLEN={INSTRENUM_FADD_H} iff((rs1_val[15:0]==ZFHEXT_LN) && (rs2_val[15:0]==ZFHEXT_SN) || (rs2_val[15:0]==ZFHEXT_LN) && (rs1_val[15:0]==ZFHEXT_SN));
        bins negL_XLENxnegS_XLEN={INSTRENUM_FADD_H} iff((rs1_val[15:0]==ZFHEXT_LN_NEG) && (rs2_val[15:0]==ZFHEXT_SN_NEG) || (rs2_val[15:0]==ZFHEXT_LN_NEG) && (rs1_val[15:0]==ZFHEXT_SN_NEG)); 
        bins L_XLENx1neg={INSTRENUM_FDIV_H} iff((rs1_val[15:0]==ZFHEXT_LN) && (rs2_val[15:0]==ZFHEXT_ONE_MINUS) || (rs2_val[15:0]==ZFHEXT_LN) && (rs1_val[15:0]==ZFHEXT_ONE_MINUS));
        bins negL_XLENxneg1neg={INSTRENUM_FDIV_H} iff((rs1_val[15:0]==ZFHEXT_LN_NEG) && (rs2_val[15:0]==ZFHEXT_ONE_MINUS_NEG) || (rs2_val[15:0]==ZFHEXT_LN_NEG) && (rs1_val[15:0]==ZFHEXT_ONE_MINUS_NEG));
    ...
    zfhext__NVflag_SNAN_feq: coverpoint instrenum_var{
        bins feq_flt_fle_rs1_posSNAN[]={INSTRENUM_FLE_H, INSTRENUM_FEQ_H, INSTRENUM_FLT_H} iff((rs1_val[15:0]==ZFHEXT_SNAN) || (rs2_val[15:0]==ZFHEXT_SNAN));
        bins feq_flt_fle_rs1_negSNAN[]={INSTRENUM_FLE_H, INSTRENUM_FEQ_H, INSTRENUM_FLT_H} iff((rs1_val[15:0]==ZFHEXT_SNAN_NEG) || (rs2_val[15:0]==ZFHEXT_SNAN_NEG));
        bins feq_flt_fle_rs1_rs2_SNAN[]={INSTRENUM_FLE_H, INSTRENUM_FEQ_H, INSTRENUM_FLT_H} iff((rs1_val[15:0]==ZFHEXT_SNAN && rs2_val[15:0]==ZFHEXT_SNAN) || (rs1_val[15:0]==ZFHEXT_SNAN && rs2_val[15:0]==ZFHEXT_SNAN_NEG) || (rs1_val[15:0]==ZFHEXT_SNAN_NEG && rs2_val[15:0]==ZFHEXT_SNAN) || (rs1_val[15:0]==ZFHEXT_SNAN_NEG && rs2_val[15:0]==ZFHEXT_SNAN_NEG));
    }
    zfhext__NVflag_QNAN_flt: coverpoint instrenum_var{
        bins flt_fle_rs1_posQNAN[]={ INSTRENUM_FEQ_H, INSTRENUM_FLT_H} iff((rs1_val[15:0]==ZFHEXT_QNAN) || (rs2_val[15:0]==ZFHEXT_QNAN));
        bins flt_fle_rs1_negQNAN[]={ INSTRENUM_FEQ_H, INSTRENUM_FLT_H} iff((rs1_val[15:0]==ZFHEXT_QNAN_NEG) || (rs2_val[15:0]==ZFHEXT_QNAN_NEG));
        bins flt_fle_rs1_rs2_QNAN[]={ INSTRENUM_FEQ_H, INSTRENUM_FLT_H} iff((rs1_val[15:0]==ZFHEXT_QNAN && rs2_val[15:0]==ZFHEXT_QNAN) || (rs1_val[15:0]==ZFHEXT_QNAN && rs2_val[15:0]==ZFHEXT_QNAN_NEG) || (rs1_val[15:0]==ZFHEXT_QNAN_NEG && rs2_val[15:0]==ZFHEXT_QNAN) || (rs1_val[15:0]==ZFHEXT_QNAN_NEG && rs2_val[15:0]==ZFHEXT_QNAN_NEG));
    }

    zfhext__NVFLAG_fmadd_zero_infinity: coverpoint rs2_val[15:0]{    
        bins zero_infinity[]={ZFHEXT_INFINITY,ZFHEXT_INFINITY_NEG} iff(rs1_val[15:0] == ZFHEXT_ZERO);
    }
    zfhext__NVFLAG_fmadd_infinity_zero: coverpoint rs1_val[15:0]{
        bins infinity_zero[]={ZFHEXT_INFINITY,ZFHEXT_INFINITY_NEG} iff(rs2_val[15:0] == ZFHEXT_ZERO);
    }
    zfhext__NVFLAG_fmadd_fmsub_fnmadd_fnmsub: coverpoint instrenum_var{ 
        bins ops[]={INSTRENUM_FNMADD_H,INSTRENUM_FNMSUB_H,INSTRENUM_FMADD_H,INSTRENUM_FMSUB_H};
    }
    ...
    zfhext__NVflag_fused_mul: coverpoint rs3_val[15:0]{
        bins qnan_rs3[]={ZFHEXT_QNAN,ZFHEXT_QNAN_NEG}; 
    }
    ...
    zfhext__NAN_cp_fsqrt_neg: coverpoint instrenum_var{
        bins fsqrt_neg={INSTRENUM_FSQRT_H}  iff(rs1_val[15]=='b1);
    }
    
    zfhext__NAN_cp_fsqrt_neg_zero: coverpoint instrenum_var{
        bins fsqrt_neg={INSTRENUM_FSQRT_H}  iff(rs1_val[15:0]==ZFHEXT_ZERO_NEG);
    }
    
    zfhext__NAN_cp_mul: coverpoint instrenum_var{
        bins fmul_pos0xposinfi={INSTRENUM_FMUL_H} iff((rs1_val[15:0]=='b0 && rs2_val[15:0]==ZFHEXT_INFINITY) || (rs2_val[15:0]=='b0 && rs1_val[15:0]==ZFHEXT_INFINITY));  
        bins fmul_pos0xneginfi={INSTRENUM_FMUL_H} iff((rs1_val[15:0]=='b0 && rs2_val[15:0]==ZFHEXT_INFINITY_NEG) || (rs2_val[15:0]=='b0 && rs1_val[15:0]==ZFHEXT_INFINITY_NEG));
        bins fmul_neg0xneginfi={INSTRENUM_FMUL_H} iff((rs1_val[15:0]==ZFHEXT_ZERO_NEG && rs2_val[15:0]==ZFHEXT_INFINITY_NEG) || (rs2_val[15:0]==ZFHEXT_ZERO_NEG && rs1_val[15:0]==ZFHEXT_INFINITY_NEG));  
        bins fmul_neg0xposinfi={INSTRENUM_FMUL_H} iff((rs1_val[15:0]==ZFHEXT_ZERO_NEG && rs2_val[15:0]==ZFHEXT_INFINITY) || (rs2_val[15:0]==ZFHEXT_ZERO_NEG && rs1_val[15:0]==ZFHEXT_INFINITY));
    }
    
    zfhext__NAN_cp_fdiv: coverpoint instrenum_var{
        bins fdiv_pos0bypos0={INSTRENUM_FDIV_H} iff((rs1_val[15:0]=='b0) && (rs2_val[15:0]=='b0));
        bins fdiv_neg0byneg0={INSTRENUM_FDIV_H} iff((rs1_val[15:0]==ZFHEXT_ZERO_NEG) && (rs2_val[15:0]==ZFHEXT_ZERO_NEG));
    }
    
    zfhext__NAN_cp_div_infbyinfi:coverpoint instrenum_var{
        bins fdiv_posinfibyposinfi={INSTRENUM_FDIV_H} iff((rs1_val[15:0]==ZFHEXT_INFINITY) && (rs2_val[15:0]==ZFHEXT_INFINITY));
        bins fdiv_neginfibyneginfi={INSTRENUM_FDIV_H} iff((rs1_val[15:0]==ZFHEXT_INFINITY_NEG) && (rs2_val[15:0]==ZFHEXT_INFINITY_NEG));
    }
    
    zfhext__NAN_cp_fsub_samesign: coverpoint instrenum_var{
        bins fsub_infmininf_ss={INSTRENUM_FSUB_H} iff((rs1_val[15:0]==ZFHEXT_INFINITY) && (rs2_val[15:0]==ZFHEXT_INFINITY));
        bins fsub_infmininf_ss_0={INSTRENUM_FSUB_H} iff((rs1_val[15:0]==ZFHEXT_INFINITY_NEG) && (rs2_val[15:0]==ZFHEXT_INFINITY_NEG));
    }
    
    zfhext__NAN_cp_fsub_notsamesign: coverpoint instrenum_var{
        bins fsub_infsubinf_10={INSTRENUM_FSUB_H} iff((rs1_val[15:0]==ZFHEXT_INFINITY) && (rs2_val[15:0]==ZFHEXT_INFINITY_NEG));
        bins fsub_infsubinf_01={INSTRENUM_FSUB_H} iff((rs1_val[15:0]==ZFHEXT_INFINITY_NEG) && (rs2_val[15:0]==ZFHEXT_INFINITY));
    }

    zfhext__DZflag_fdiv: coverpoint instrenum_var{
        bins fdiv_DZFLagset_pos0={INSTRENUM_FDIV_H} iff(rs2_val[15:0]=='b0);
        bins fdiv_DZFLagset_neg0={INSTRENUM_FDIV_H} iff(rs2_val[15:0]==ZFHEXT_ZERO_NEG);
    }

    zfhext__OF_NXFLAG_fadd : coverpoint instrenum_var{
        bins fadd_LNpos_posno ={INSTRENUM_FADD_H} iff((rs1_val[15:0]==ZFHEXT_LN && rs2_val[15]=='b0) || (rs2_val[15:0]==ZFHEXT_LN && rs1_val[15]=='b0));
        bins fadd_LNneg_posno ={INSTRENUM_FADD_H} iff((rs1_val[15:0]==ZFHEXT_LN_NEG && rs2_val[15]=='b0) || (rs2_val[15:0]==ZFHEXT_LN_NEG && rs1_val[15]=='b0));
    }
    ...
    zfhext__OF_NXflag_fmul : coverpoint instrenum_var{
        bins fmul_LNpos_1pluspos={INSTRENUM_FMUL_H} iff((rs1_val[15:0]==ZFHEXT_LN && rs2_val[15:0]==ZFHEXT_ONE_PLUS) || (rs2_val[15:0]==ZFHEXT_LN && rs1_val[15:0]==ZFHEXT_ONE_PLUS));
        bins fmul_LNneg_1pluspos={INSTRENUM_FMUL_H} iff((rs1_val[15:0]==ZFHEXT_LN_NEG && rs2_val[15:0]==ZFHEXT_ONE_PLUS) || (rs2_val[15:0]==ZFHEXT_LN_NEG && rs1_val[15:0]==ZFHEXT_ONE_PLUS));
        bins fmul_LNpos_1plusneg={INSTRENUM_FMUL_H} iff((rs1_val[15:0]==ZFHEXT_LN && rs2_val[15:0]==ZFHEXT_ONE_PLUS_NEG) || (rs2_val[15:0]==ZFHEXT_LN && rs1_val[15:0]==ZFHEXT_ONE_PLUS_NEG));
        bins fmul_LNneg_1plusneg={INSTRENUM_FMUL_H} iff((rs1_val[15:0]==ZFHEXT_LN_NEG && rs2_val[15:0]==ZFHEXT_ONE_PLUS_NEG) || (rs2_val[15:0]==ZFHEXT_LN_NEG && rs1_val[15:0]==ZFHEXT_ONE_PLUS_NEG));
    }
    ...
    zfhext__UF_flag_fdiv: coverpoint instrenum_var{
        bins fdiv_SNby2={INSTRENUM_FDIV_H} iff((rs1_val[15:0]==ZFHEXT_SN) && (rs2_val[15:0]==ZFHEXT_TWO));
        bins fdiv_SNby2_n={INSTRENUM_FDIV_H} iff((rs1_val[15:0]==ZFHEXT_SN_NEG) && (rs2_val[15:0]==ZFHEXT_TWO_NEG));
    }

        zfhext__UF_fsub_SN_SN_plus: coverpoint instrenum_var{
        bins fsub_SN_SNplus={INSTRENUM_FSUB_H} iff((rs1_val[15:0]==ZFHEXT_SN) && (rs2_val[15:0]==16'h0401));
       
    }

    zfhext__NXflag_fdiv: coverpoint instrenum_var{
        bins fdiv_one_by_three={INSTRENUM_FDIV_H} iff((rs1_val[15:0]==ZFHEXT_ONE) && (rs2_val[15:0]==ZFHEXT_THREE));
    }

    zfhext__NX_UFflag_fdiv_SSN_by_three: coverpoint instrenum_var{
        bins fdiv_SSN_by_three ={INSTRENUM_FDIV_H} iff((rs1_val[15:0]==ZFHEXT_SSN && rs2_val[15:0]==ZFHEXT_THREE) || (rs1_val[15:0]==ZFHEXT_SSN_NEG && rs2_val[15:0]==ZFHEXT_THREE)); 
    }

    zfhext__NX_UFflag_fdiv_SSN_by_two: coverpoint instrenum_var{
        bins fdiv_SSN_by_two ={INSTRENUM_FDIV_H} iff((rs1_val[15:0]==ZFHEXT_SSN && rs2_val[15:0]==ZFHEXT_TWO) || (rs1_val[15:0]==ZFHEXT_SSN_NEG && rs2_val[15:0]==ZFHEXT_TWO));
    }
    ...
    zfhext__NAN_memory_operation_FLH: coverpoint instrenum_var{
       bins FLH_SNAN ={INSTRENUM_FLH} iff(rd_val[15:0]== ZFHEXT_SNAN || rd_val[15:0]== ZFHEXT_SNAN_NEG);
    }

     zfhext__NAN_memory_operation_FSH: coverpoint instrenum_var{
        bins FLH_SNAN ={INSTRENUM_FSH} iff(rd_val[15:0]==ZFHEXT_SNAN || rd_val[15:0]==ZFHEXT_SNAN_NEG);
     }

     zfhext__NAN_memory_operation_FLH_NCNAN: coverpoint instrenum_var{
        bins FLH_SNAN ={INSTRENUM_FLH} iff((rd_val[15:8]==8'h7e && rd_val[7:0] != 0) || (rd_val[15:8]==16'hfe && rd_val[7:0] != 0));
     }

     //SID:035
     zfhext__NAN_memory_operation_FSH_NCNAN: coverpoint instrenum_var{
        bins FLH_SNAN ={INSTRENUM_FSH} iff((rd_val[15:8]==8'h7e && rd_val[7:0] != 0) || (rd_val[15:8]==16'hfe && rd_val[7:0] != 0));
     }
 ...
 //SCENARIO 12
     ...
     zfhext_NAN_arithmetic_feq_flt_fle: coverpoint instrenum_var{
        bins feq_flt_fle[]={INSTRENUM_FLE_H, INSTRENUM_FLT_H, INSTRENUM_FEQ_H};
     }
     zfhext_NAN_arithmetic_feq_flt_fle_cross1: cross zfhext_NAN_arithmetic_feq_flt_fle,zfhext_NAN_arithmetic_rs1; 
     zfhext_NAN_arithmetic_feq_flt_fle_cross2: cross zfhext_NAN_arithmetic_feq_flt_fle,zfhext_NAN_arithmetic_rs2; //need to update this

    //SID:037
    zfhext__NAN_arithmetic_fsub_fdiv: coverpoint instrenum_var{
        bins fdiv_fsub[]={INSTRENUM_FSUB_H,INSTRENUM_FDIV_H};
     }
...
//SCENARIO 13
    ...
    zfhext__Generic_special_NAN_ZERO_rs1: coverpoint instrenum_var{
        option.weight=0;
        bins scenario_13_1[]={INSTRENUM_FADD_H,INSTRENUM_FMUL_H,INSTRENUM_FSUB_H,INSTRENUM_FDIV_H,INSTRENUM_FSQRT_H,INSTRENUM_FMIN_H,INSTRENUM_FMAX_H} iff(rs2_val[15:0] == 0);
        
     }
    zfhext__Generic_special_NAN_ZERO_rs2: coverpoint instrenum_var{
        option.weight=0;
        bins scenario_13_1[]={INSTRENUM_FADD_H,INSTRENUM_FMUL_H,INSTRENUM_FSUB_H,INSTRENUM_FDIV_H,INSTRENUM_FSQRT_H,INSTRENUM_FMIN_H,INSTRENUM_FMAX_H} iff(rs1_val[15:0] == 0);
    ...
    zfhext__Generic_special_Fmin_Fmax: coverpoint instrenum_var{
        option.weight=0;
        bins fmin_fmax_NAN[]={INSTRENUM_FMIN_H,INSTRENUM_FMAX_H}; 
    }
    ...
    //SID:040
    //TODO:need to code all the rs1,rs2 values seperately
    zfhext__Generic_special_case3_rs1_diffvalues: coverpoint rs1_val[15:0]{
        option.weight=0;
         bins SNAN_rs1= {ZFHEXT_SNAN};
       // bins SNAN_neg_rs1={ZFHEXT_SNAN_NEG};
        bins QNAN__rs1={ZFHEXT_QNAN};
        //bins QNAN_neg_s1={ZFHEXT_QNAN_NEG};
        bins NCNAN_rs1={[16'h7e01:16'h7eff]};
        //bins NCNAN_neg_rs1={[63'hffc00001:63'hffcfffff]}; 
        bins LN_rs1={ZFHEXT_LN};
        //bins LN_neg={ZFHEXT_LN_NEG}
    ...
    zfhext__Generic_special_case3_ops: coverpoint instrenum_var{
        bins case3={INSTRENUM_FADD_H,INSTRENUM_FMUL_H,INSTRENUM_FSUB_H,INSTRENUM_FDIV_H,INSTRENUM_FSQRT_H,INSTRENUM_FMIN_H,INSTRENUM_FMAX_H,INSTRENUM_FMADD_H, INSTRENUM_FMSUB_H, INSTRENUM_FNMADD_H, INSTRENUM_FNMSUB_H}; //iff((rs1_val[15:0] || rs2_val[15:0]) == ((ZFHEXT_SNAN) || (ZFHEXT_SNAN_NEG) || (ZFHEXT_QNAN) || (ZFHEXT_QNAN_NEG) || (63'h7fcxxxxx) || (63'hffcxxxxx) || (ZFHEXT_INFINITY) || (ZFHEXT_INFINITY_NEG) || (16'h0000) || (ZFHEXT_ZERO_NEG) || (ZFHEXT_LN) || (ZFHEXT_LN_NEG) || (ZFHEXT_SSN) || (ZFHEXT_SSN_NEG)));
    }
...
//SCENARIO 14
     ...
     zfhext__Computational_fmin_fmax_zero: coverpoint instrenum_var{
        bins fmin_fmax_case1_1[]={INSTRENUM_FMIN_H,INSTRENUM_FMAX_H} iff((rs1_val[15:0]==16'h0000) && (rs2_val[15:0]==16'h0000)); 
        bins fmin_fmax_case1_2[]={INSTRENUM_FMIN_H,INSTRENUM_FMAX_H} iff((rs1_val[15:0]==16'h0000) && (rs2_val[15:0]==ZFHEXT_ZERO_NEG));
        bins fmin_fmax_case1_3[]={INSTRENUM_FMIN_H,INSTRENUM_FMAX_H} iff((rs1_val[15:0]==ZFHEXT_ZERO_NEG) && (rs2_val[15:0]==ZFHEXT_ZERO_NEG));
        bins fmin_fmax_case1_4[]={INSTRENUM_FMIN_H,INSTRENUM_FMAX_H} iff((rs1_val[15:0]==ZFHEXT_ZERO_NEG) && (rs2_val[15:0]==16'h0000));
     //Have to code another case left SID_RV64F_043
     }

     //SID:042
     zfhext__Computational_fmin_fmax_NCNAN: coverpoint instrenum_var{
         bins fmin_fmax_case2[]={INSTRENUM_FMIN_H,INSTRENUM_FMAX_H} iff(((rs1_val[15:8]==8'h7e && rs1_val[7:0] != 0) && (rs2_val[15:8]==8'h7e && rs2_val[7:0] != 0)) || ((rs1_val[15:8]==8'hfe && rs1_val[7:0] != 0) && (rs2_val[15:8]==8'hfe && rs2_val[7:0] != 0)));
  
     }
     //SID:043 has already been covered in SID:039

    //SID:044
     zfhext__Computational_fmadd_fnmadd: coverpoint instrenum_var{
        bins fmadd_fmsub_fnmsub_fnmadd[]={INSTRENUM_FMADD_H, INSTRENUM_FMSUB_H, INSTRENUM_FNMADD_H, INSTRENUM_FNMSUB_H} iff(rs1_val[15:0] == rs2_val[15:0]);
     }


//SCENARIO 15
     //SID:045
    // SID:045:Ensure sign extenstion is done correctly
    zfhext__Conversion_move_fcvt: coverpoint instrenum_var{
        bins fcvt_diff_types_ZFH[]={INSTRENUM_FCVT_L_H, INSTRENUM_FCVT_LU_H, INSTRENUM_FCVT_H_L,INSTRENUM_FCVT_H_LU,INSTRENUM_FCVT_H_W,INSTRENUM_FCVT_H_WU,INSTRENUM_FCVT_W_H,INSTRENUM_FCVT_WU_H};
    }

     //SID:046 
    zfhext__Conversion_move_x0: coverpoint instrenum_var{
        bins fcvt_ZFH_X[]={INSTRENUM_FCVT_H_W,INSTRENUM_FCVT_H_L,INSTRENUM_FCVT_H_LU,INSTRENUM_FCVT_H_WU} iff(rs1==0);
    }

    //SID:047:Ensure rm has no effect on the conversions
    zfhext__cross_conversions: coverpoint instrenum_var{
        bins cross_zfh[]={INSTRENUM_FCVT_S_H,INSTRENUM_FCVT_D_H};
    }

    zfhext__cross_extenstion_coversion: coverpoint instrenum_var{
        bins inject_instr_H[]={INSTRENUM_FSGNJ_H,INSTRENUM_FSGNJN_H,INSTRENUM_FSGNJX_H};
    ...
    zfhext__Softfloat_fdiv: coverpoint instrenum_var{
        bins fdiv_s[]={INSTRENUM_FDIV_H,INSTRENUM_FSQRT_H};
    }
    ...
    zfhext__Softfloat_convert_cross_roundmodes_dyn: cross zfhext__Conversion_move_fcvt,zfhext__rounding_modes_dynamic_legal;
