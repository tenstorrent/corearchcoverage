...
covergroup dext__cg with function sample(csr_cov_sample i_csr);
    ...
    dext__rounding_modes_invalid_FRM: coverpoint Inst[14:12] {
        bins illegal_mode[] = {5,6} iff((match_dext==1) && ((instrenum_var != INSTRENUM_FLD) || (instrenum_var != INSTRENUM_FSD))); 
    }

    dext__rounding_modes_static_legal_rm : coverpoint Inst[14:12] {
        bins hit[] = {0,1,2,3,4} iff(match_dext==1);
    }
   
    dext__rounding_modes_dynamic_illegal: coverpoint i_csr.fcsr_csr_inst.frm{
        bins illegal_mode_2[] = {3'd5,3'd6,3'd7} iff((match_dext==1) && (Inst[14:12] == 3'b111) && ((instrenum_var != INSTRENUM_FLD) || (instrenum_var != INSTRENUM_FSD))); 
    }
 
    dext__rounding_modes_dynamic_legal: coverpoint i_csr.fcsr_csr_inst.frm{
        bins dynamic_mode[] = {3'd1,3'd2,3'd3,3'd0,3'd4} iff((match_dext==1) && (Inst[14:12] == 3'd7) && ((instrenum_var != INSTRENUM_FLD) || (instrenum_var != INSTRENUM_FSD)));
    }
    ...
    dext__rounding_modes_edge_case: coverpoint instrenum_var{
        bins L_XLENx1plus={INSTRENUM_FMUL_D} iff(((rs1_val==DEXT_LN) && (rs2_val==DEXT_ONE_PLUS)) || ((rs2_val==DEXT_LN) && (rs1_val==DEXT_ONE_PLUS)));
        bins negL_XLENxneg1plus={INSTRENUM_FMUL_D} iff(((rs1_val==DEXT_LN_NEG) && (rs2_val==DEXT_ONE_PLUS_NEG)) || ((rs2_val==DEXT_LN_NEG) && (rs1_val==DEXT_ONE_PLUS_NEG)));
        bins L_XLENxS_XLEN={INSTRENUM_FADD_D} iff(((rs1_val==DEXT_LN) && (rs2_val==DEXT_SN)) || ((rs2_val==DEXT_LN) && (rs1_val==DEXT_SN)));
        bins negL_XLENxnegS_XLEN={INSTRENUM_FADD_D} iff(((rs1_val==DEXT_LN_NEG) && (rs2_val==DEXT_SN_NEG)) || ((rs2_val==DEXT_LN_NEG) && (rs1_val==DEXT_SN_NEG))); 
        bins L_XLENx1neg={INSTRENUM_FDIV_D} iff(((rs1_val==DEXT_LN) && (rs2_val==DEXT_ONE_MINUS)) || ((rs2_val==DEXT_LN) && (rs1_val==DEXT_ONE_MINUS)));
        bins negL_XLENxneg1neg={INSTRENUM_FDIV_D} iff(((rs1_val==DEXT_LN_NEG) && (rs2_val==DEXT_ONE_MINUS_NEG)) || ((rs2_val==DEXT_LN_NEG) && (rs1_val==DEXT_ONE_MINUS_NEG)));
    ...
    dext__NVflag_SNAN_feq: coverpoint instrenum_var{
        bins feq_flt_fle_rs1_posSNAN[]={INSTRENUM_FLE_D, INSTRENUM_FEQ_D, INSTRENUM_FLT_D} iff((rs1_val[63:0]==DEXT_SNAN) || (rs2_val[63:0]==DEXT_SNAN));
        bins feq_flt_fle_rs1_negSNAN[]={INSTRENUM_FLE_D, INSTRENUM_FEQ_D, INSTRENUM_FLT_D} iff((rs1_val[63:0]==DEXT_SNAN_NEG) || (rs2_val[63:0]==DEXT_SNAN_NEG));
        bins feq_flt_fle_rs1_rs2_SNAN[]={INSTRENUM_FLE_D, INSTRENUM_FEQ_D, INSTRENUM_FLT_D} iff((rs1_val[63:0]==DEXT_SNAN && rs2_val[63:0]==DEXT_SNAN) || (rs1_val[63:0]==DEXT_SNAN && rs2_val[63:0]==DEXT_SNAN_NEG) || (rs1_val[63:0]==DEXT_SNAN_NEG && rs2_val[63:0]==DEXT_SNAN) || (rs1_val[63:0]==DEXT_SNAN_NEG && rs2_val[63:0]==DEXT_SNAN_NEG));
    }

    dext__NVflag_QNAN_flt: coverpoint instrenum_var{
        bins flt_fle_rs1_posQNAN[]={ INSTRENUM_FEQ_D, INSTRENUM_FLT_D} iff((rs1_val[63:0]==DEXT_QNAN) || (rs2_val[63:0]==DEXT_QNAN));
        bins flt_fle_rs1_negQNAN[]={ INSTRENUM_FEQ_D, INSTRENUM_FLT_D} iff((rs1_val[63:0]==DEXT_QNAN_NEG) || (rs2_val[63:0]==DEXT_QNAN_NEG));
        bins flt_fle_rs1_rs2_QNAN[]={ INSTRENUM_FEQ_D, INSTRENUM_FLT_D} iff((rs1_val[63:0]==DEXT_QNAN && rs2_val[63:0]==DEXT_QNAN) || (rs1_val[63:0]==DEXT_QNAN && rs2_val[63:0]==DEXT_QNAN_NEG) || (rs1_val[63:0]==DEXT_QNAN_NEG && rs2_val[63:0]==DEXT_QNAN) || (rs1_val[63:0]==DEXT_QNAN_NEG && rs2_val[63:0]==DEXT_QNAN_NEG));
    }

    dext__NVFLAG_fmadd_zero_infinity: coverpoint rs2_val{   
        bins zero_infinity[]={DEXT_INFINITY,DEXT_INFINITY_NEG} iff(rs1_val == DEXT_ZERO);
    }
    dext__NVFLAG_fmadd_infinity_zero: coverpoint rs1_val{  
        bins infinity_zero[]={DEXT_INFINITY,DEXT_INFINITY_NEG} iff(rs2_val == DEXT_ZERO);
    }
    dext__NVFLAG_fmadd_fmsub_fnmadd_fnmsub: coverpoint instrenum_var{
        bins ops[]={INSTRENUM_FNMADD_D,INSTRENUM_FNMSUB_D,INSTRENUM_FMADD_D,INSTRENUM_FMSUB_D};
    }
    ...
    dext__NVflag_fused_mul: coverpoint rs3_val{
        bins qnan_rs3[]={DEXT_QNAN,DEXT_QNAN_NEG}; 
    }
    ...
    dext__NAN_cp_fsqrt_neg: coverpoint instrenum_var{
        bins fsqrt_neg={INSTRENUM_FSQRT_D}  iff(rs1_val[63]=='b1);
    }

    dext__NAN_cp_fsqrt_neg_zero: coverpoint instrenum_var{
        bins fsqrt_neg={INSTRENUM_FSQRT_D}  iff(rs1_val[63:0]==DEXT_ZERO_NEG);
    }

    dext__NAN_cp_mul: coverpoint instrenum_var{
        bins fmul_pos0xposinfi={INSTRENUM_FMUL_D} iff((rs1_val[63:0]=='b0 && rs2_val[63:0]==DEXT_INFINITY) || (rs2_val[63:0]=='b0 && rs1_val[63:0]==DEXT_INFINITY));  
        bins fmul_pos0xneginfi={INSTRENUM_FMUL_D} iff((rs1_val[63:0]=='b0 && rs2_val[63:0]==DEXT_INFINITY_NEG) || (rs2_val[63:0]=='b0 && rs1_val[63:0]==DEXT_INFINITY_NEG));
        bins fmul_neg0xneginfi={INSTRENUM_FMUL_D} iff((rs1_val[63:0]==DEXT_ZERO_NEG && rs2_val[63:0]==DEXT_INFINITY_NEG) || (rs2_val[63:0]==DEXT_ZERO_NEG && rs1_val[63:0]==DEXT_INFINITY_NEG));  
        bins fmul_neg0xposinfi={INSTRENUM_FMUL_D} iff((rs1_val[63:0]==DEXT_ZERO_NEG && rs2_val[63:0]==DEXT_INFINITY) || (rs2_val[63:0]==DEXT_ZERO_NEG && rs1_val[63:0]==DEXT_INFINITY));
    }

    dext__NAN_cp_fdiv: coverpoint instrenum_var{
        bins fdiv_pos0bypos0={INSTRENUM_FDIV_D} iff((rs1_val[63:0]=='b0) && (rs2_val[63:0]=='b0));
        bins fdiv_neg0byneg0={INSTRENUM_FDIV_D} iff((rs1_val[63:0]==DEXT_ZERO_NEG) && (rs2_val[63:0]==DEXT_ZERO_NEG));
    }

    dext__NAN_cp_div_infbyinfi:coverpoint instrenum_var{
        bins fdiv_posinfibyposinfi={INSTRENUM_FDIV_D} iff((rs1_val[63:0]==DEXT_INFINITY) && (rs2_val[63:0]==DEXT_INFINITY));
        bins fdiv_neginfibyneginfi={INSTRENUM_FDIV_D} iff((rs1_val[63:0]==DEXT_INFINITY_NEG) && (rs2_val[63:0]==DEXT_INFINITY_NEG));
    }

    dext__NAN_cp_fsub_samesign: coverpoint instrenum_var{
        bins fsub_infmininf_ss={INSTRENUM_FSUB_D} iff((rs1_val[63:0]==DEXT_INFINITY) && (rs2_val[63:0]==DEXT_INFINITY));
        bins fsub_infmininf_ss_0={INSTRENUM_FSUB_D} iff((rs1_val[63:0]==DEXT_INFINITY_NEG) && (rs2_val[63:0]==DEXT_INFINITY_NEG));
    }

    dext__NAN_cp_fsub_notsamesign: coverpoint instrenum_var{
        bins fsub_infsubinf_10={INSTRENUM_FSUB_D} iff((rs1_val[63:0]==DEXT_INFINITY) && (rs2_val[63:0]==DEXT_INFINITY_NEG));
        bins fsub_infsubinf_01={INSTRENUM_FSUB_D} iff((rs1_val[63:0]==DEXT_INFINITY_NEG) && (rs2_val[63:0]==DEXT_INFINITY));
    }

    dext__DZflag_fdiv: coverpoint instrenum_var{
        bins fdiv_DZFLagset_pos0={INSTRENUM_FDIV_D} iff(rs2_val[63:0]=='b0);
        bins fdiv_DZFLagset_neg0={INSTRENUM_FDIV_D} iff(rs2_val[63:0]==DEXT_ZERO_NEG);
    }

    dext__OF_NXFLAG_fadd : coverpoint instrenum_var{
    bins fadd_LNpos_posno ={INSTRENUM_FADD_D} iff((rs1_val[63:0]==DEXT_LN && rs2_val[63]=='b0) || (rs2_val[63:0]==DEXT_LN && rs1_val[63]=='b0));
    bins fadd_LNneg_posno ={INSTRENUM_FADD_D} iff((rs1_val[63:0]==DEXT_LN_NEG && rs2_val[63]=='b0) || (rs2_val[63:0]==DEXT_LN_NEG && rs1_val[63]=='b0));
    ...
    dext__OF_NXflag_fmul : coverpoint instrenum_var{
        bins fmul_LNpos_1pluspos={INSTRENUM_FMUL_D} iff((rs1_val[63:0]==DEXT_LN && rs2_val[63:0]==DEXT_ONE_PLUS) || (rs2_val[63:0]==DEXT_LN && rs1_val[63:0]==DEXT_ONE_PLUS));
        bins fmul_LNneg_1pluspos={INSTRENUM_FMUL_D} iff((rs1_val[63:0]==DEXT_LN_NEG && rs2_val[63:0]==DEXT_ONE_PLUS) || (rs2_val[63:0]==DEXT_LN_NEG && rs1_val[63:0]==DEXT_ONE_PLUS));
        bins fmul_LNpos_1plusneg={INSTRENUM_FMUL_D} iff((rs1_val[63:0]==DEXT_LN && rs2_val[63:0]==DEXT_ONE_PLUS_NEG) || (rs2_val[63:0]==DEXT_LN && rs1_val[63:0]==DEXT_ONE_PLUS_NEG));
        bins fmul_LNneg_1plusneg={INSTRENUM_FMUL_D} iff((rs1_val[63:0]==DEXT_LN_NEG && rs2_val[63:0]==DEXT_ONE_PLUS_NEG) || (rs2_val[63:0]==DEXT_LN_NEG && rs1_val[63:0]==DEXT_ONE_PLUS_NEG));
    }
    ...
    dext__UF_flag_fdiv : coverpoint instrenum_var{
        bins fdiv_SNby2={INSTRENUM_FDIV_D} iff((rs1_val[63:0]==DEXT_SN) && (rs2_val[63:0]==DEXT_TWO));
        bins fdiv_SNby2_n={INSTRENUM_FDIV_D} iff((rs1_val[63:0]==DEXT_SN_NEG) && (rs2_val[63:0]==DEXT_TWO_NEG));
    }
  
    dext__UF_fsub_SN_SN_plus: coverpoint instrenum_var{
        bins fsub_SN_SNplus={INSTRENUM_FSUB_D} iff((rs1_val[63:0]==DEXT_SN) && (rs2_val[63:0]==63'h0010000000000001));
       
    }

    dext__NXflag_fdiv: coverpoint instrenum_var{
        bins fdiv_one_by_three={INSTRENUM_FDIV_D} iff((rs1_val[63:0]==DEXT_ONE) && (rs2_val[63:0]==DEXT_THREE));
    }

    dext__NX_UFflag_fdiv_SSN_by_three: coverpoint instrenum_var{
        bins fdiv_SSN_by_three ={INSTRENUM_FDIV_D} iff((rs1_val[63:0]==DEXT_SSN && rs2_val[63:0]==DEXT_THREE) || (rs1_val[63:0]==DEXT_SSN_NEG && rs2_val[63:0]==DEXT_THREE)); 
    }

    dext__NX_UFflag_fdiv_SSN_by_two: coverpoint instrenum_var{
        bins fdiv_SSN_by_two ={INSTRENUM_FDIV_D} iff((rs1_val[63:0]==DEXT_SSN && rs2_val[63:0]==DEXT_TWO) || (rs1_val[63:0]==DEXT_SSN_NEG && rs2_val[63:0]==DEXT_TWO));
    }
    ...
    dext__NAN_memory_operation_FLD: coverpoint instrenum_var{
        bins FLD_SNAN ={INSTRENUM_FLD} iff(rd_val[63:0]== DEXT_SNAN || rd_val[63:0]== DEXT_SNAN_NEG);
    }

    dext__NAN_memory_operation_FSD: coverpoint instrenum_var{
        bins FLD_SNAN ={INSTRENUM_FSD} iff(rd_val[63:0]==DEXT_SNAN || rd_val[63:0]==DEXT_SNAN_NEG);
    }

    dext__NAN_memory_operation_FLD_NCNAN: coverpoint instrenum_var{
        bins FLD_SNAN ={INSTRENUM_FLD} iff((rd_val[63:48]==16'h7ff8 && rd_val[47:0] != 0) || (rd_val[63:48]==16'hfff8 && rd_val[47:0] != 0));
    }

    dext__NAN_memory_operation_FSD_NCNAN: coverpoint instrenum_var{
        bins FLD_SNAN ={INSTRENUM_FSD} iff((rd_val[63:48]==16'h7ff8 && rd_val[47:0] != 0) || (rd_val[63:48]==16'hfff8 && rd_val[47:0] != 0));
    }
    ...
    dext_NAN_arithmetic_feq_flt_fle: coverpoint instrenum_var{
        bins feq_flt_fle[]={INSTRENUM_FLE_D, INSTRENUM_FLT_D, INSTRENUM_FEQ_D};
    }
    dext_NAN_arithmetic_feq_flt_fle_cross1: cross dext_NAN_arithmetic_feq_flt_fle,dext_NAN_arithmetic_rs1; 
    dext_NAN_arithmetic_feq_flt_fle_cross2: cross dext_NAN_arithmetic_feq_flt_fle,dext_NAN_arithmetic_rs2; // need to update this

    dext__NAN_arithmetic_fsub_fdiv: coverpoint instrenum_var{
        bins fdiv_fsub[]={INSTRENUM_FSUB_D,INSTRENUM_FDIV_D};
    }
    ...
    dext__Generic_special_NAN_ZERO_rs1: coverpoint instrenum_var{
        option.weight=0;
        bins scenario_13_1[]={INSTRENUM_FADD_D,INSTRENUM_FMUL_D,INSTRENUM_FSUB_D,INSTRENUM_FDIV_D,INSTRENUM_FSQRT_D,INSTRENUM_FMIN_D,INSTRENUM_FMAX_D} iff(rs2_val == 0);

    }
    dext__Generic_special_NAN_ZERO_rs2: coverpoint instrenum_var{
        option.weight=0;
        bins scenario_13_1[]={INSTRENUM_FADD_D,INSTRENUM_FMUL_D,INSTRENUM_FSUB_D,INSTRENUM_FDIV_D,INSTRENUM_FSQRT_D,INSTRENUM_FMIN_D,INSTRENUM_FMAX_D} iff(rs1_val == 0);
    ...
    dext__Generic_special_Fmin_Fmax: coverpoint instrenum_var{
        option.weight=0;
        bins fmin_fmax_NAN[]={INSTRENUM_FMIN_D,INSTRENUM_FMAX_D}; 
    }
    ...
    dext__Generic_special_case3_ops: coverpoint instrenum_var{
        bins case3={INSTRENUM_FADD_D,INSTRENUM_FMUL_D,INSTRENUM_FSUB_D,INSTRENUM_FDIV_D,INSTRENUM_FSQRT_D,INSTRENUM_FMIN_D,INSTRENUM_FMAX_D,INSTRENUM_FMADD_D, INSTRENUM_FMSUB_D, INSTRENUM_FNMADD_D, INSTRENUM_FNMSUB_D}; // iff((rs1_val[63:0] || rs2_val[63:0]) == ((DEXT_SNAN) || (DEXT_SNAN_NEG) || (DEXT_QNAN) || (DEXT_QNAN_NEG) || (63'h7fcxxxxx) || (63'hffcxxxxx) || (DEXT_INFINITY) || (DEXT_INFINITY_NEG) || (63'h0000000000000000) || (DEXT_ZERO_NEG) || (DEXT_LN) || (DEXT_LN_NEG) || (DEXT_SSN) || (DEXT_SSN_NEG)));
    }
    ...
    dext__Computational_fmin_fmax_zero: coverpoint instrenum_var{
        bins fmin_fmax_case1_1[]={INSTRENUM_FMIN_D,INSTRENUM_FMAX_D} iff((rs1_val[63:0]==63'h0000000000000000) && (rs2_val[63:0]==63'h0000000000000000)); 
        bins fmin_fmax_case1_2[]={INSTRENUM_FMIN_D,INSTRENUM_FMAX_D} iff((rs1_val[63:0]==63'h0000000000000000) && (rs2_val[63:0]==DEXT_ZERO_NEG));
        bins fmin_fmax_case1_3[]={INSTRENUM_FMIN_D,INSTRENUM_FMAX_D} iff((rs1_val[63:0]==DEXT_ZERO_NEG) && (rs2_val[63:0]==DEXT_ZERO_NEG));
        bins fmin_fmax_case1_4[]={INSTRENUM_FMIN_D,INSTRENUM_FMAX_D} iff((rs1_val[63:0]==DEXT_ZERO_NEG) && (rs2_val[63:0]==63'h0000000000000000));
    }

    dext__Computational_fmin_fmax_NCNAN: coverpoint instrenum_var{
        bins fmin_fmax_case2[]={INSTRENUM_FMIN_D,INSTRENUM_FMAX_D} iff(((rs1_val[63:48]==16'h7ff8 && rs1_val[47:0] != 0) && (rs2_val[63:48]==16'h7ff8 && rs2_val[47:0] != 0)) || ((rs1_val[63:48]==16'hfff8 && rs1_val[47:0] != 0) && (rs2_val[63:48]==16'hfff8 && rs2_val[47:0] != 0)));
    ...
    dext__Conversion_move_x0: coverpoint instrenum_var{
        bins fcvt_D_X[]={INSTRENUM_FCVT_D_W,INSTRENUM_FCVT_D_L,INSTRENUM_FCVT_D_LU,INSTRENUM_FCVT_D_WU} iff(rs1==0);
    }

    dext__cross_conversions: coverpoint instrenum_var{
        bins cross_d[]={INSTRENUM_FCVT_D_S,INSTRENUM_FCVT_D_H};
    }

    dext__cross_extenstion_coversion: coverpoint instrenum_var{
        bins inject_instr_D[]={INSTRENUM_FSGNJ_D,INSTRENUM_FSGNJN_D,INSTRENUM_FSGNJX_D};
    ...
    dext__Softfloat_fdiv: coverpoint instrenum_var{
        bins fdiv_s[]={INSTRENUM_FDIV_D,INSTRENUM_FSQRT_D};
    }
    ...
    dext__Softfloat_convert_cross_roundmodes_dyn: cross dext__Conversion_move_fcvt,dext__rounding_modes_dynamic_legal;
endgroup
