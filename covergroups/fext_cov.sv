...
covergroup fext__cg with function sample(csr_cov_sample i_csr);
    ...
    fext__non_ls_instrs: coverpoint fext_var {
    ...
    fext__rounding_modes_dynamic_illegal: coverpoint Inst[14:12] {
        bins vals[] = {5,6,7};
    }   
    ...
    fext__rounding_modes_illegal : cross fext__non_ls_instrs, fext__rounding_modes_dynamic_illegal;
    fext__rounding_modes_valid   : cross fext__non_ls_instrs, fext__rounding_modes_static_legal_rm;
    ...
    fext__rounding_modes_edge_case: coverpoint instrenum_var{
        bins L_XLENx1plus   =   {
            INSTRENUM_FMUL_S
        } iff(((rs1_val[31:0]==FEXT_LN) && (rs2_val[31:0]==FEXT_ONE_PLUS)) || ((rs2_val[31:0]==FEXT_LN) && (rs1_val[31:0]==FEXT_ONE_PLUS)));

        bins negL_XLENxneg1plus =   {
            INSTRENUM_FMUL_S
        } iff(((rs1_val[31:0]==FEXT_LN_NEG) && (rs2_val[31:0]==FEXT_ONE_PLUS_NEG)) || ((rs2_val[31:0]==FEXT_LN_NEG) && (rs1_val[31:0]==FEXT_ONE_PLUS_NEG)));

        bins L_XLENxS_XLEN  =   {
            INSTRENUM_FADD_S
        } iff(((rs1_val[31:0]==FEXT_LN) && (rs2_val[31:0]==FEXT_SN)) || ((rs2_val[31:0]==FEXT_LN) && (rs1_val[31:0]==FEXT_SN)));
    
        bins negL_XLENxnegS_XLEN    =   {
            INSTRENUM_FADD_S
        } iff(((rs1_val[31:0]==FEXT_LN_NEG) && (rs2_val[31:0]==FEXT_SN_NEG)) || ((rs2_val[31:0]==FEXT_LN_NEG) && (rs1_val[31:0]==FEXT_SN_NEG))); 

        bins L_XLENx1neg = {
            INSTRENUM_FDIV_S
        } iff(((rs1_val[31:0]==FEXT_LN) && (rs2_val[31:0]==FEXT_ONE_MINUS)) || ((rs2_val[31:0]==FEXT_LN) && (rs1_val[31:0]==FEXT_ONE_MINUS)));

        bins negL_XLENxneg1neg  =   {
            INSTRENUM_FDIV_S
        } iff(((rs1_val[31:0]==FEXT_LN_NEG) && (rs2_val[31:0]==FEXT_ONE_MINUS_NEG)) || ((rs2_val[31:0]==FEXT_LN_NEG) && (rs1_val[31:0]==FEXT_ONE_MINUS_NEG)));
    }
    ...
    fext__NVflag_SNAN_feq: coverpoint instrenum_var{
        ...
        bins feq_flt_fle_rs1_posSNAN[] = {
            ...
            INSTRENUM_FEQ_S,
            INSTRENUM_FLT_S
        } iff((rs1_val[31:0]==FEXT_SNAN) || (rs2_val[31:0]==FEXT_SNAN));

        bins feq_flt_fle_rs1_negSNAN[]  =   {
            INSTRENUM_FLE_S,
            INSTRENUM_FEQ_S,
            INSTRENUM_FLT_S
        } iff((rs1_val[31:0]==FEXT_SNAN_NEG) || (rs2_val[31:0]==FEXT_SNAN_NEG));
        ...
        bins feq_flt_fle_rs1_rs2_SNAN[] =   {
            ...
            INSTRENUM_FLT_S
                ...
                (rs1_val[31:0]==FEXT_SNAN && rs2_val[31:0]==FEXT_SNAN_NEG) ||
                (rs1_val[31:0]==FEXT_SNAN_NEG && rs2_val[31:0]==FEXT_SNAN) ||
                (rs1_val[31:0]==FEXT_SNAN_NEG && rs2_val[31:0]==FEXT_SNAN_NEG)
            );
    }
    ...
    fext__NVflag_QNAN_flt: coverpoint instrenum_var{
        ...
        bins flt_fle_rs1_posQNAN[]  =   {
            INSTRENUM_FEQ_S,
            INSTRENUM_FLT_S
        } iff((rs1_val[31:0]==FEXT_QNAN) || (rs2_val[31:0]==FEXT_QNAN));

        bins flt_fle_rs1_negQNAN[]  =   {
            INSTRENUM_FEQ_S,
            INSTRENUM_FLT_S
        } iff((rs1_val[31:0]==FEXT_QNAN_NEG) || (rs2_val[31:0]==FEXT_QNAN_NEG));

        bins flt_fle_rs1_rs2_QNAN[] =   {
            INSTRENUM_FEQ_S,
            INSTRENUM_FLT_S
        } iff(  (rs1_val[31:0]==FEXT_QNAN && rs2_val[31:0]==FEXT_QNAN)      ||
                (rs1_val[31:0]==FEXT_QNAN && rs2_val[31:0]==FEXT_QNAN_NEG)  ||
                (rs1_val[31:0]==FEXT_QNAN_NEG && rs2_val[31:0]==FEXT_QNAN)  ||
                (rs1_val[31:0]==FEXT_QNAN_NEG && rs2_val[31:0]==FEXT_QNAN_NEG)
            );
    }
    ...
    fext__NAN_cp_fsqrt_neg_zero: coverpoint instrenum_var{
        bins fsqrt_neg  =   {
            INSTRENUM_FSQRT_S
        }  iff(rs1_val[31:0]==FEXT_ZERO_NEG);
    }
    ...
    fext__NAN_cp_mul: coverpoint instrenum_var{
        ...
        bins fmul_pos0xposinfi  =   {
            INSTRENUM_FMUL_S
        } iff(  (rs1_val[31:0]=='b0 && rs2_val[31:0]==FEXT_INFINITY) ||
                (rs2_val[31:0]=='b0 && rs1_val[31:0]==FEXT_INFINITY)
            );

        bins fmul_pos0xneginfi  =   {
            INSTRENUM_FMUL_S
        } iff(  (rs1_val[31:0]=='b0 && rs2_val[31:0]==FEXT_INFINITY_NEG) ||
                (rs2_val[31:0]=='b0 && rs1_val[31:0]==FEXT_INFINITY_NEG)
            );

        bins fmul_neg0xneginfi  =   {
            INSTRENUM_FMUL_S
        } iff(  (rs1_val[31:0]==FEXT_ZERO_NEG && rs2_val[31:0]==FEXT_INFINITY_NEG) ||
                (rs2_val[31:0]==FEXT_ZERO_NEG && rs1_val[31:0]==FEXT_INFINITY_NEG)
            );

        bins fmul_neg0xposinfi  =   {
            INSTRENUM_FMUL_S
        } iff(  (rs1_val[31:0]==FEXT_ZERO_NEG && rs2_val[31:0]==FEXT_INFINITY) ||
                (rs2_val[31:0]==FEXT_ZERO_NEG && rs1_val[31:0]==FEXT_INFINITY)
            );
    }
    ...
    fext__NAN_cp_fdiv: coverpoint instrenum_var{
        ...
        bins fdiv_pos0bypos0    =   {
            INSTRENUM_FDIV_S
        } iff((rs1_val[31:0]=='b0) && (rs2_val[31:0]=='b0));

        bins fdiv_neg0byneg0    =   {
            INSTRENUM_FDIV_S
        } iff((rs1_val[31:0]==FEXT_ZERO_NEG) && (rs2_val[31:0]==FEXT_ZERO_NEG));
    }
    ...
    fext__NAN_cp_div_infbyinfi:coverpoint instrenum_var{
        ...
        bins fdiv_posinfibyposinfi  =   {
            INSTRENUM_FDIV_S
        } iff((rs1_val[31:0]==FEXT_INFINITY) && (rs2_val[31:0]==FEXT_INFINITY));

        bins fdiv_neginfibyneginfi  =   {
            INSTRENUM_FDIV_S
        } iff((rs1_val[31:0]==FEXT_INFINITY_NEG) && (rs2_val[31:0]==FEXT_INFINITY_NEG));
    }
    ...
    fext__NAN_cp_fsub_notsamesign: coverpoint instrenum_var{
        ...
        bins fsub_infsubinf_10  =   {
            INSTRENUM_FSUB_S
        } iff((rs1_val[31:0]==FEXT_INFINITY) && (rs2_val[31:0]==FEXT_INFINITY_NEG));

        bins fsub_infsubinf_01  =   {
            INSTRENUM_FSUB_S
        } iff((rs1_val[31:0]==FEXT_INFINITY_NEG) && (rs2_val[31:0]==FEXT_INFINITY));
    }
    ...
    fext__DZflag_fdiv: coverpoint instrenum_var{
        ...
        bins fdiv_DZFLagset_neg0    =   {
            INSTRENUM_FDIV_S
        } iff(rs2_val[31:0]==FEXT_ZERO_NEG);
    }
    ...
    fext__OF_NXFLAG_fadd : coverpoint instrenum_var{
        ...
        bins fadd_LNpos_posno   =   {
            INSTRENUM_FADD_S
        } iff(  (rs1_val[31:0]==FEXT_LN && rs2_val[31]=='b0) ||
                (rs2_val[31:0]==FEXT_LN && rs1_val[31]=='b0)
            );

        bins fadd_LNneg_posno   =   {
            INSTRENUM_FADD_S
        } iff(  (rs1_val[31:0]==FEXT_LN_NEG && rs2_val[31]=='b0) ||
                (rs2_val[31:0]==FEXT_LN_NEG && rs1_val[31]=='b0)
            );
    }
    ...
    fext__OF_NXflag_fmul : coverpoint instrenum_var{
        ...
        bins fmul_LNpos_1pluspos    =   {
            INSTRENUM_FMUL_S
        } iff(  (rs1_val[31:0]==FEXT_LN && rs2_val[31:0]==FEXT_ONE_PLUS) ||
                (rs2_val[31:0]==FEXT_LN && rs1_val[31:0]==FEXT_ONE_PLUS)
            );

        bins fmul_LNneg_1pluspos    =   {
            INSTRENUM_FMUL_S
        } iff(  (rs1_val[31:0]==FEXT_LN_NEG && rs2_val[31:0]==FEXT_ONE_PLUS) ||
                (rs2_val[31:0]==FEXT_LN_NEG && rs1_val[31:0]==FEXT_ONE_PLUS)
            );

        bins fmul_LNpos_1plusneg    =   {
            INSTRENUM_FMUL_S
        } iff(  (rs1_val[31:0]==FEXT_LN && rs2_val[31:0]==FEXT_ONE_PLUS_NEG) ||
                (rs2_val[31:0]==FEXT_LN && rs1_val[31:0]==FEXT_ONE_PLUS_NEG)
            );

        bins fmul_LNneg_1plusneg    =   {
            INSTRENUM_FMUL_S
        } iff(  (rs1_val[31:0]==FEXT_LN_NEG && rs2_val[31:0]==FEXT_ONE_PLUS_NEG) ||
                (rs2_val[31:0]==FEXT_LN_NEG && rs1_val[31:0]==FEXT_ONE_PLUS_NEG)
            );
    }
    ...
    fext__UF_flag_fdiv : coverpoint instrenum_var{
        ...
        bins fdiv_SNby2 =   {
            INSTRENUM_FDIV_S
        } iff((rs1_val[31:0]==FEXT_SN) && (rs2_val[31:0]==FEXT_TWO));

        bins fdiv_SNby2_n   =   {
            INSTRENUM_FDIV_S
        } iff((rs1_val[31:0]==FEXT_SN_NEG) && (rs2_val[31:0]==FEXT_TWO_NEG));
    }
    ...
    fext__UF_fsub_SN_SN_plus: coverpoint instrenum_var{
        ...
        bins fsub_SN_SNplus =   {
            INSTRENUM_FSUB_S
        } iff((rs1_val[31:0]==FEXT_SN) && (rs2_val[31:0]==32'h00800001));
    }
    ...
    fext__NXflag_fdiv: coverpoint instrenum_var{
        ...
        bins fdiv_one_by_three =   {
            INSTRENUM_FDIV_S
        } iff((rs1_val[31:0]==FEXT_ONE) && (rs2_val[31:0]==FEXT_THREE));
    }
    ...
    fext__NX_UFflag_fdiv_SSN_by_three: coverpoint instrenum_var{
        ...
        bins fdiv_SSN_by_three =   {
            INSTRENUM_FDIV_S
        } iff(  (rs1_val[31:0]==FEXT_SSN && rs2_val[31:0]==FEXT_THREE) ||
                (rs1_val[31:0]==FEXT_SSN_NEG && rs2_val[31:0]==FEXT_THREE)
            );
    }
    ...
    fext__NX_UFflag_fdiv_SSN_by_two: coverpoint instrenum_var{
        ...
        bins fdiv_SSN_by_two    =   {
            INSTRENUM_FDIV_S
        } iff(  (rs1_val[31:0]==FEXT_SSN && rs2_val[31:0]==FEXT_TWO) ||
                (rs1_val[31:0]==FEXT_SSN_NEG && rs2_val[31:0]==FEXT_TWO)
            );
    }
    ...
    fext__NAN_memory_operation_FLW: coverpoint instrenum_var{
        ...
        bins flw_SNAN   =   {
            INSTRENUM_FLW
        } iff(rd_val[31:0]==FEXT_SNAN || rd_val[31:0]==FEXT_SNAN_NEG);
    }
    ...
    fext__NAN_memory_operation_FLW_NCNAN: coverpoint instrenum_var{
        ...
        bins flw_SNAN   =   {
            INSTRENUM_FLW
        } iff(  (rd_val[31:20]==12'h7fc && rd_val[19:0] != 0) ||
                (rd_val[31:20]==12'hffc && rd_val[19:0] != 0)
            );
    }
    ...
    fext_NAN_arithmetic_feq_flt_fle_cross2: cross fext_NAN_arithmetic_feq_flt_fle,fext_NAN_arithmetic_rs2; 
    ...
    fext__Computational_fmin_fmax_zero: coverpoint instrenum_var{
        ...
        bins fmin_fmax_case1_1[]    =   {
                INSTRENUM_FMIN_S,
                INSTRENUM_FMAX_S
            } iff((rs1_val[31:0]==32'h00000000) && (rs2_val[31:0]==32'h00000000));
        bins fmin_fmax_case1_2[]    =   {
                INSTRENUM_FMIN_S,
                INSTRENUM_FMAX_S
            } iff((rs1_val[31:0]==32'h00000000) && (rs2_val[31:0]==FEXT_ZERO_NEG));
        ...
        bins fmin_fmax_case1_4[]    =   {
                INSTRENUM_FMIN_S,
                INSTRENUM_FMAX_S
            } iff((rs1_val[31:0]==FEXT_ZERO_NEG) && (rs2_val[31:0]==32'h00000000));
    }
    ...
    fext__Computational_fmin_fmax_NCNAN: coverpoint instrenum_var{
        bins fmin_fmax_case2[]={
            INSTRENUM_FMIN_S,
            INSTRENUM_FMAX_S
        } iff(  ((rs1_val[31:20]==12'h7fc && rs1_val[19:0] != 0) && (rs2_val[31:20]==12'h7fc && rs2_val[19:0] != 0)) ||
                ((rs1_val[31:20]==12'hffc && rs1_val[19:0] != 0) && (rs2_val[31:20]==12'hffc && rs2_val[19:0] != 0))
            );
    }
    ...
    fext__Computational_fmadd_fnmadd: coverpoint instrenum_var{
        bins fmadd_fmsub_fnmsub_fnmadd[]    =   {
            ...
            INSTRENUM_FNMADD_S,
            INSTRENUM_FNMSUB_S
        } iff(rs1_val[31:0]==rs2_val[31:0]);
    }

    fext__Conversion_move_fcvt: coverpoint instrenum_var{
        bins fcvt_diff_types_S[]    =   {
            INSTRENUM_FCVT_L_S,
            INSTRENUM_FCVT_LU_S,
            INSTRENUM_FCVT_S_L,
            INSTRENUM_FCVT_S_LU,
